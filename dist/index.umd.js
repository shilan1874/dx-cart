(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('number-precision')) :
  typeof define === 'function' && define.amd ? define(['exports', 'number-precision'], factory) :
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.dxCart = {}, global.NP));
}(this, (function (exports, NP) { 'use strict';
  ...
  const getCartPrice = ({ saleItems }) => {
    ...
    if (saleItems.length === 0) {
      ...
      saleItems.forEach((item) => {
        discountsTotalPrice += NP__default['default'].times(item.detailPrice, item.skuQty);
      });
      return {
        discountsTotalPrice,
      }
  ...
  exports.dispatchAddLocalCart = dispatchAddLocalCart;
  exports.dispatchCartCount = dispatchCartCount;
  exports.dispatchCartInfo = dispatchCartInfo;
  exports.dispatchCartItemCount = dispatchCartItemCount;
  exports.dispatchCartItemSelect = dispatchCartItemSelect;
  exports.getCartList = getCartList;
  exports.getCartPrice = getCartPrice;
  exports.syncCartItemCount = syncCartItemCount;
